...
import (
	...
	utilsPerdin "github.com/arkaramadhan/its-vo/common/models"
...
func DeleteFileHandlerPerdin(c *gin.Context) {
	...
	result := initializers.DB.Where("file_path = ?", fullPath).Delete(&utilsPerdin.File{})
	if result.Error != nil {
